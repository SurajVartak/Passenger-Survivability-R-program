...
Dataset <- read.csv(file="C:/OLD PC/MSIS/Third Semester/IS 777 Data Analytics/data set/Airbag and other influences on accident fatalities.csv", header=TRUE, sep=",")
summary(Dataset)
Dataset$X <- NULL
Dataset$weight <- NULL
Dataset$dead <- NULL
...
#implementing cross validation to find out best value of lambda
set.seed(1)
